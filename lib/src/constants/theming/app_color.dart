...
class AppColor {
  ...
  static const FlexSchemeColor _myScheme1Light = FlexSchemeColor(
    primary: Color(0xFF651BFF),
    primaryContainer: Color(0xFFAB92BF),
    secondary: Color(0xFFB5BA72),
    secondaryContainer: Color(0xFF7F8161),
    tertiary: Color(0xFF416320),
    tertiaryContainer: Color(0xFF3C5029),
...
// options users can switch to and use if they like.
  static final List<FlexSchemeData> schemes = <FlexSchemeData>[
    ...
    const FlexSchemeData(
      name: 'C1: Violet Electric',
      description: 'idk what i want to write here',
